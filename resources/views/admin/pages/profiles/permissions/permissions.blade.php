      ...
      <div class="card-header">
        <div class="row">
          <div class="col-md-8">
            ...
            <a href="{{route('profile.permissions.available', $profile->id)}}" class="btn bg-gradient-primary  " data-toggle="tooltip" data-placement="top"
            title="Adicionar nova permissão" ><i
                class="fas fa-plus"></i> Adicionar nova permissão</a>
          </div>
          <div class="col-md-4">

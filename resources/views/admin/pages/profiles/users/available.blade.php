...
@section('title', ' Pessoas disponiveis - ')
...
@section('plugins.icheck-bootstrap', true)
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Pessoas disponíveis para o perfil <strong>{{ $profile->nome }}</strong></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('dashboard.index')}}">Dashbord</a></li>
                    <li class="breadcrumb-item "><a href="{{route('profiles.index')}}">Perfis</a></li>
                    <li class="breadcrumb-item a"><a href="{{route('profiles.users',$profile->id)}}">Pessoas do perfil</a></li>
            ...
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card-tools">
                                <form action="{{ route('profile.users.available', $profile->id) }}" method="post"
                ...
                <div class="card-body table-responsive p-0 ">
                    <table class="table table-hover ">
                        ...
                        <tbody>
                            <form action="{{route('profile.users.attach', $profile->id )}}" method="POST">
                                @csrf

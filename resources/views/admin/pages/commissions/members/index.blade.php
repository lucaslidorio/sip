...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1>Membros da comissão - <strong> <td>{{$commission->nome}}</td>   </strong></h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="card">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table table-hover">
          ...
          <tbody>           
            @foreach($commission->members as $councilor)       
            ...
            <tr>
              ...
              <td>{{$commission->tipo == 1 ? 'Permanente' : 'Temporária'}}</td>
                ...
                <a href="{{route('commissions.members.index', $commission->id)}}" data-id="{{$commission->id}}"

...
<div class="card mb-3 mt-3 border " id="printable-card">
  ...
  <div class="row no-gutters justify-content-center pt-3">
    <h4 class="text-center">RELATÓRIO DE CREDENCIAMENO AGRUPADO - PROCESSO Nº: {{$processo->numero}}/{{$processo->data_publicacao->year}}</h4>
  </div>
 
  <div class="row no-gutters  " style="padding:15px">    
    <div class="col-md-3 mb-0 col-print-3" style="padding-left: 15px">

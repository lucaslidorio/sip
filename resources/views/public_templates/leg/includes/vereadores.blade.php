            ...
            <div class="highlights2-texts">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col">
                            <img style="width:100%; height:280px" class="img-fluid" src="{{ config('app.aws_url') . "
                                {$vereador->img}" }}"
                                    ...
                                    <h4>
                                        <div style="width: 100%;" class="col-md-1 col-sm-1 col-xs-1">
                                            <div style="width: 80px; float: left;">
                                                <img width="50px" src="{{ config('app.aws_url')."
                                                    {$vereador->party->img}" }}"
                                                alt="">
                                            </div>
                                            <div style="width: 70%; padding-top: 3%; float: right; color: #666;">
                                                {{ $vereador->nome }}
                                            </div>
                                        </div>
                                    </h4>

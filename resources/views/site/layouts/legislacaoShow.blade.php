      ...
      <div class="container">        
        <div class="section-header">
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">
              LEGISLACÕES DO PODER <span>LEGISLATIVO </span>
          </h2>
        ...
        <div class="shadow-lg p-5 mb-15 bg-white rounded">
          ...
          <div class="card " >
            ...
            <h6>Legislação  -   <strong> {{$legislacao->type_legislations->nome}} </strong> <h6>  
            </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col">{{$legislacao->numero}}</th>              
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th scope="row">Data</th>
                  <td>{{\Carbon\Carbon::parse($legislacao->data)->format('d/m/Y')}}</td>
                </tr>
                <tr>
                  <th scope="row">Anexo(s)</th>
                  <td >
                    @foreach ($legislacao->attachments as $anexo)
                ...
                <tr>
                  ...
                  <td colspan="2">{{$legislacao->caput}}</td>                
                </tr>
                <tr>
                  <th scope="row" colspan="2">Texto de lei</th>
                               
                </tr>
                <tr>
                  <td colspan="2">{!!$legislacao->descricao!!}</td>  
                </tr>
